...
namespace Bpocallaghan\Corporate\Commands;
...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'corporate:publish';
    ...
    private function copyModels()
    {
        ...
        // copy files
        $search = "namespace Bpocallaghan\Corporate\Models;";
    ...
    {
        // ADMIN
        $source = $this->basePath . "resources\\views\admin\\tenders";
        $destination = resource_path('views\admin\corporate\\tenders');
        $this->copyFilesFromSource($source, $destination);

        $source = $this->basePath . "resources\\views\admin\\vacancies";
        $destination = resource_path('views\admin\corporate\\vacancies');
        $this->copyFilesFromSource($source, $destination);

        $source = $this->basePath . "resources\\views\admin\annual_reports";
        $destination = resource_path('views\admin\corporate\annual_reports');
        $this->copyFilesFromSource($source, $destination);

        // WEBSITE
        $source = $this->basePath . "resources\\views\website";
        $destination = resource_path('views\website\corporate');
        $this->copyFilesFromSource($source, $destination);
    }
    ...
    private function copyControllers()
    {
        ...
        $destination = app_path('Http\Controllers\Admin\Corporate');

        // copy files
        $search = ["corporate::", "Bpocallaghan\Corporate\Models", "namespace Bpocallaghan\Corporate\Controllers\Admin;"];
        $replace = ["corporate.", "App\Models", "namespace App\Http\Controllers\Admin\Corporate;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
        ...
        // replace files
        $search = ["corporate::", "Bpocallaghan\Corporate\Models", "namespace Bpocallaghan\Corporate\Controllers\Website;"];
        $replace = ["corporate.", "App\Models", "namespace App\Http\Controllers\Website;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
    }
    ...
    private function copyDatabase()
    {
        ...
        $search = "namespace Bpocallaghan\Corporate\Seeds;";
        ...
        $search = "namespace Bpocallaghan\Corporate\Migrations;";
        $this->copyFilesFromSource($source, $destination, $search);
    }
